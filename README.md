...
## using ssis to integrat and transform the data set 

###  1. intgrate 3 execl sheets 
![ScreenShot_20221121164612](https://user-images.githubusercontent.com/61375401/203101484-e4f75415-62fe-4031-880d-3661d4ac201f.jpeg)

###  2. using a C# script to transform , clean the data 
![dict](https://user-images.githubusercontent.com/61375401/203102704-d435f511-3825-4195-af1c-01c122a75014.jpeg)

###  3. use the dict to replace country data , and rplace null values also all this using foreach loop and if condition 
![dict 2](https://user-images.githubusercontent.com/61375401/203104925-fb916365-7e60-48df-a68a-d42ababb0281.jpeg)

### 4. then union all the data and load it into the destination database 
